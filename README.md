...
| 	b0x	| 	[![alt text][web]](https://b0x.network/) | [![alt text][github]](https://github.com/bZxNetwork) | [![alt text][whitepaper]](https://b0x.network/pdfs/bZx_white_paper.pdf) | | 	(dev - TGE expected Q2 2018)	| 	b0x protocol (margin lending/trading and oracle marketplace)	| 	| | | | |
...
| Blackhalo | [![alt text][web]](http://blackhalo.info/) | [![alt text][github]](https://github.com/dzimbeck/Halo) | | `FULLY` | (operating - beta) | TBC |   | | | | |
...
| 	Dether	| 	[![alt text][web]](https://dether.io/) | [![alt text][github]](https://github.com/dethertech)	| | | 	(dev)	| 	TBC	| 6	| | | | |
...
| DEXON dex |  [![alt text][web]](https://dexon.org/) | [![alt text][github]](https://github.com/dexon-foundation) |  [![alt text][whitepaper]](https://eprint.iacr.org/2018/1112.pdf) |   | (dev) | TBC |   |   | DEXON | Dexon Foundation |   |
...
| DEx.top |  [![alt text][web]](https://dex.top/) | [![alt text][github]](https://github.com/dexDev/DEx.top) | [![alt text][whitepaper]](https://github.com/dexDev/DEx.top/blob/master/whitepaper/DEx-Whitepaper-Short-Version.pdf)  |  | (live) | replayed-on-chain protocol |   |   |  |   |   |
...
| 	DutchX	| [![alt text][web]](https://gnosis.pm/)	 | [![alt text][github]](https://github.com/gnosis/dx-react)	| [![alt text][whitepaper]](https://dutchx.readthedocs.io) | `FULLY` | 	(live)	| 	dutch auction principle protocol	| 	| ERC20 Tokens | Ethereum | Gnosis  | |
| 	dYdX	| [![alt text][web]](https://dydx.exchange/) | [![alt text][github]](https://github.com/dydxprotocol/protocol) | [![alt text][whitepaper]](https://whitepaper.dydx.exchange/) | | 	(dev)	| 	dYdX protocol	| 5	| ERC20 Tokens - Dydx Derivatives (Option - Short Sell) | Ethereum | | |
...
| 	EOSfinex	| 	[![alt text][web]](https://www.eosfinex.com/) |	| | | 	(dev)	| 	eos protocol	| 	| | EOS | | |
| 	ERC dEX	| 	[![alt text][web]](https://app.ercdex.com) | [![alt text][github]](https://github.com/ERCdEX) | | | 	(operating)	| 	0x protocol	| 	| | | | |
...
| 	EtherDelta	| 	[![alt text][web]](https://etherdelta.com) | [![alt text][github]](https://github.com/etherdelta)	| | `FULLY` | 	(operating)	| 	on-chain protocol	| Ethereum	| | | | |
| 	EtherEx	| 	[![alt text][web]](https://etherex.github.io/etherex) | [![alt text][github]](https://github.com/etherex/etherex)	| | | 	(operating)	| 	TBC	| 	| | | | |
| 	EtherFlyer	| 	[![alt text][web]](https://www.etherflyer.com/) |	| | | 	(operating)	| 	TBC	| 	| | | | |
| 	EtherMium	| 	[![alt text][web]](https://ethermium.com/) |	| [![alt text][whitepaper]](https://docs.ethermium.devify.net/) | | 	(operating)	| 	TBC	| 	| ERC20 Tokens | Ethereum | | |
| 	Ether Wager	| 	[![alt text][web]](https://eth-wager.surge.sh/) |	| | | 	(operating)	| 	oraclize protocol	| 	| | | | |
...
| 	Ethos 	| [![alt text][web]](https://www.ethos.io/) |   | [![alt text][whitepaper]](https://www.ethos.io/Ethos_Whitepaper.pdf) | `DCD` `DS` | (dev) | multi protocol (0x - atomic swap) | 6 | | | | |
| 	Everbloom	| 	[![alt text][web]](https://everbloom.co/) |	| [![alt text][whitepaper]](https://docs.everbloom.co/) | `FULLY` | 	(operating)	| 	multi-protocol	| 	| ERC20 | Ethereum | | |
...
| 	Exchangily	| 	[![alt text][web]](https://exchangily.com/) | | [![alt text][whitepaper]](https://exchangily.com/assets/pdfs/wp-en.pdf) | `DOM` `FULLY` `DG` `OPRO` `RELAY` `ACL` | 	(dev)	| 	Fast Access Blockchain protocol	| 	| All | Fast Access Blockchain (FAB) | | |
| Expread | [![alt text][web]](http://expread.io/) |   | |   | (dev) | payment channels protocol |   | | | | |
| 	faast	| 	[![alt text][web]](https://faa.st/) | [![alt text][github]](https://github.com/go-faast)	| | `FULLY` | 	(dev)	| 	0x protocol	| 14	| | | | |
| 	Fetch Trading	| 	[![alt text][web]](https://www.fetchtrading.com/) |	| | | 	(dev)	| 	0x protocol	| 	| | | | |
| 	Forkdelta	| 	[![alt text][web]](https://forkdelta.app) |	[![alt text][github]](https://github.com/forkdelta/) | | | 	(operating)	| 	on-chain protocol	| 	| | | | |
| 	Freedom Ledger	| 	[![alt text][web]](https://www.freedomledger.com/) |	| | | 	(dev)	| 	bitshares protocol (DPOS)	| 	| | | | |
| Fusion | [![alt text][web]](https://fusion.org/) | [![alt text][github]](https://github.com/FUSIONFoundation/) | [![alt text][whitepaper]](https://docs.wixstatic.com/ugd/76b9ac_be5c61ff0e3048b3a21456223d542687.pdf) |   | (dev) | fusion protocol | 2 | | | | |
...
| 	Graphene	| 	[![alt text][web]](https://docs.bitshares.eu//index.html) |	| | | 	(operating)	| 	bitshares protocol (Graphene)	| 2	| | | | |
| 	Heat	| 	[![alt text][web]](https://heatwallet.com) |	[![alt text][github]](https://github.com/Heat-Ledger-Ltd/) | [![alt text][whitepaper]](https://heatledger.com/HEATWhitepaper.pdf) | | 	(operating)	| 	asset-to-asset protocol	| 	| | | | |
| 	Herdius	| 	[![alt text][web]](https://herdius.com/) | [![alt text][web]](https://github.com/herdius)	| [![alt text][whitepaper]](https://herdius.com/whitepaper/Herdius_Whitepaper_1.1.pdf) | | 	(dev)	| 	cross-chain protocol	| 	| | | | |
...
| 	Hydra	| 	[![alt text][web]](https://libertaria.world/) |	| [![alt text][whitepaper]](https://libertaria.world/wp-content/uploads/2018/01/Libertaria_Project_Hydra__Vision_Paper-1.pdf) | | 	(dev - whitepaper)	| 	hydra protocol	| 2	| | | | |
...
| 	Hodl⚡️co	| 	[![alt text][web]](https://www.hodlco.io) |	| | | 	(dev)	| 	TBC | 6	| | | | |
| 	IDEX	| 	[![alt text][web]](https://idex.market/) |	| | | 	(operating)	| 	snowglobe protocol	| 	| | | | |
| 	IDT Exchange	| 	[![alt text][web]](https://kinalpha.com/) |	| | | 	(operating)	| 	0x protocol	| 	| | | | |
| 	Inbest Network	| 	[![alt text][web]](https://www.inbest.network/) |	| | | 	(ICO)	| 	inbest protocol	| 4	| | | | |
| Infinity | [![alt text][web]](https://www.hycon.io/) | [![alt text][github]](https://github.com/Team-Hycon) | [![alt text][whitepaper]](https://hycon.io/wp-content/uploads/2018/08/whitepaper1.2.2_en.pdf) |   | (dev) | spectre protocol |   |   |   |   |   |
...
| 	JOYSO	| 	[![alt text][web]](https://joyso.io/) |	| [![alt text][whitepaper]](https://joyso.io/wp-content/uploads/2018/11/JOYSO-whitepaper.pdf) | | 	(ICO)	| 	hex protocol	| 3	| | | | |
| Komodo | [![alt text][web]](https://www.komodoplatform.com/) | [![alt text][github]](https://github.com/KomodoPlatform) | [![alt text][whitepaper]](https://www.komodoplatform.com/wp-content/uploads/2018/06/Komodo-Whitepaper-June-3.pdf) |   | (dev) | komodo protocol | 2 | N/A | Komodo | | |
| 	KyberNetwork	| 	[![alt text][web]](https://kyber.network) | [![alt text][github]](https://github.com/kyberNetwork/)	| [![alt text][whitepaper]](https://developer.kyber.network/docs/Start/) | | 	(live)	| 	kyber protocol	| 	| ERC20 Tokens | Ethereum | | |
...
| 	LAtoken	| 	[![alt text][web]](https://www.latoken.com/) |	| | | 	(operating)	| 	spectre protocol (DAG)	| 	| | | | |
|   LedgerDex |   [![alt text][web]](https://www.ledgerdex.com/) | [![alt text][github]](https://github.com/ledgerdex)  | | |   (operating - beta)  |   0x protocol |   | | | | |
| 	Legolas Exchange	| 	[![alt text][web]](https://lgo.exchange/) |	| [![alt text][whitepaper]](https://lgo.group/pdf/legolas-whitepaper-part-2.pdf) | | 	(dev - ICO Q1 2018)	| 	legolas protocol	| 3	| | | | |
| 	Lendroid	| 	[![alt text][web]](https://www.lendroid.com/) | [![alt text][github]](https://github.com/lendroidproject)	| [![alt text][whitepaper]](https://uploads-ssl.webflow.com/5b3d0e23faf03c5dc943df64/5b3d0e23faf03c96e243df86_whitepaper-margin-trading-2-18.pdf) | | 	(dev)	| 	lendroid protocol |	| ERC20 Tokens | Ethereum | | |
...
| LocalCoinSwap | [![alt text][web]](https://www.localcoinswap.com/) | [![alt text][github]](https://github.com/LocalCoinSwap) | [![alt text][whitepaper]](https://static.localcoinswap.com/exchange/assets/docs/LocalCoinSwap_whitepaper_v1.0.pdf) |   | (dev) | lcs protocol |   |   |   |   |   |
| 	Loopring	| 	[![alt text][web]](https://loopring.org) | [![alt text][github]](https://github.com/loopring) 	| [![alt text][whitepaper]](https://github.com/Loopring/whitepaper/blob/master/en_whitepaper.pdf) | | 	operating	| 	loopring protocol	| 2	| ERC20 Tokens | Ethereum | | |
...
| MARKET Protocol | [![alt text][web]](https://www.marketprotocol.io/) | [![alt text][github]](https://github.com/MarketProject/MarketProtocol) | [![alt text][whitepaper]](https://marketprotocol.io/assets/MARKET_Protocol-Whitepaper.pdf) |   | (dev) | MARKET Protocol |   | Derivatives | Ethereum |   |   |
...
| 	MoonDEX	| 	[![alt text][web]](https://moondex.org/) | [![alt text][github]](https://github.com/Moondex)	| | | 	(dev)	| 	TBC	| 	| | | | |
...
| 	NEX	| 	[![alt text][web]](https://neonexchange.org/) |	| [![alt text][whitepaper]](https://neonexchange.org/pdfs/whitepaper_v2.pdf) | | 	(dev - launch Q3 2018)	| 	off-chain protocol	| 	| | | | |
...
| 	NVO	| 	[![alt text][web]](https://nvo.io/) | [![alt text][github]](https://github.com/nvoproject) | | | 	(dev - launch Q1 2018)	| 	nvo protocol	|	| | | | |
...
| Oasis Direct | [![alt text][web]](https://oasis.direct/) | [![alt text][github]](https://github.com/OasisDEX/oasis-direct) | [![alt text][whitepaper]](https://developer.makerdao.com/) | `FULLY` | (operating) | on-chain protocol |   |   |   |   |   |
| 	Omega One	| 	[![alt text][web]](https://dark.omega.one/) |	| | | 	(ICO)	| 	TBC	| 	| | | | |
| 	OmiseGO	| 	[![alt text][web]](https://omisego.network/) |	| [![alt text][whitepaper]](https://cdn.omise.co/omg/whitepaper.pdf) | | 	(dev)	| 	omisego protocol	| 2 | All | All| | |
| 	Omni DEX	| 	[![alt text][web]](https://blog.omni.foundation/2016/03/16/omnidex-getting-started/) |	| | | 	(operating)	| 	TBC	| 	| | | | |
...
| 	openANX	| 	[![alt text][web]](https://www.oax.org/en) | [![alt text][github]](https://gitlab.com/oax) | [![alt text][whitepaper]](https://www.oax.org/assets/whitepaper/openANX_White_Paper_ENU.pdf) | | 	(dev)	| 	openanx protocol	| 	| | | | |
| 	OpenLedger DEX	| 	[![alt text][web]](https://openledger.io/) |	| | | 	(operating)	| 	bitshares protocol (DPOS)	| 	| | | | |
| 	Open Relay	| 	[![alt text][web]](https://openrelay.xyz/) | [![alt text][github]](https://github.com/NoteGio/openrelay) | [![alt text][whitepaper]](https://openrelay.xyz/docs/) | `FULLY` `RELAY` | (dev - private alpha) | 0x protocol | | | | | |
| Open Trading Network | [![alt text][web]](https://otn.org/) | [![alt text][github]](https://github.com/OpenTradingNetworkFoundation) | [![alt text][whitepaper]](https://otn.org/assets/resources/otn_white_paper_en_v3.pdf?1547739302513) |   | (dev) | otn protocol |   |   |   |   |   |
| 	Orderbook	| 	[![alt text][web]](https://www.orderbook.io) | [![alt text][github]](https://github.com/Orderbookio)	|   | | 	(released)	| 	ethereum protocol	| 	| | | | |
| 	Paradex	| 	[![alt text][web]](https://paradex.io/) | [![alt text][github]](https://github.com/ParadexRelayer)	| | | 	(operating - beta)	| 	0x protocol	| 	| | | | |
...
| Plaak | [![alt text][web]](https://plaak.io/) | [![alt text][github]](https://github.com/zeked2013/PLAAK) | [![alt text][whitepaper]](http://plaak.com/docs/PLAAK-Whitepaper-V2-Freelance.pdf) | `DCD` | (dev) | TBC |   | | | | |
| 	PlutusDEX |	[![alt text][web]](https://plutus.it/dex) | | [![alt text][whitepaper]](https://plutus.it/public/white-paper.pdf) | |	(operating) |	TBC |	 | | | | |
...
| 	Raidex	| 	[![alt text][web]](https://raidex.io/) |	| | | 	(dev)	| 	raiden protocol	|	| | | | |
| 	Relayer Network	| 	[![alt text][web]](https://relayer.network/) |	| | | 	(dev)	| 	0x protocol (modular trade networks)	|	| | | | |
| 	Republic Protocol	| [![alt text][web]](https://republicprotocol.com/) | [![alt text][github]](https://github.com/republicprotocol/)	| [![alt text][whitepaper]](https://republicprotocol.com/litepaper.pdf) | | 	(released)	| 	republic protocol	| 2	| | | | |
| 	RigoBlock	| [![alt text][web]](https://rigoblock.com/) | [![alt text][github]](https://github.com/rigoblock) | [![alt text][whitepaper]](https://rigoblock.com/assets/downloads/white-paper.pdf) | | 	(operating with issues)	| 	rigoblock protocol	| | | | | |
|   Ripple | [![alt text][web]](https://ripple.com) | [![alt text][github]](https://github.com/ripple/) | [![alt text][whitepaper]](https://whitepaperdatabase.com/ripple-xrp-whitepaper/) | | (released) | ripple protocol | 2	| XRP - Ripple Issued Currencies | Ripple | | |
| River Exchange |   | [![alt text][github]](https://github.com/didil/river-x) |   | `FULLY` | (dev) | TBC |   | | | | |
| 	RSK	| 	[![alt text][web]](https://www.rsk.co/) | [![alt text][github]](https://github.com/rsksmart/)	| [![alt text][whitepaper]](https://docs.rsk.co/RSK_White_Paper-Overview.pdf) | | 	(dev)	| 	rsk protocol	| 2	| | | | |
| 	RuDEX	| 	[![alt text][web]](https://rudex.org/) | [![alt text][github]](https://github.com/blckchnd/rudex-ui) | | | 	(operating - beta)	| 	bitshares protocol (Graphene)	|	| | | | |
| 	SAFEX	|  | [![alt text][github]](https://github.com/dallyshalla/safex-while)	| | | 	(released)	| 	safex protocol	| 2	| | | | |
| 	Saturn	| [![alt text][web]](https://saturn.network/)  | [![alt text][github]](https://github.com/rados-io)	| [![alt text][whitepaper]](https://forum.saturn.network/t/saturn-network-whitepaper-v1-2/1552) |  | 	(released)	| 	saturn protocol	| 2	| ERC20 Tokens - ERC223 Tokens | Ethereum | | |
| 	SDEX	| 	[![alt text][web]](https://www.stellar.org/blog/2018-Stellar-Roadmap/) | | | | 	(dev)	| 	stellar consensus protocol	| 	| | | | |
| 	Settle	| 	| [![alt text][github]](https://github.com/spolu/settle/) | | | 	(dev)	| 	settle protocol	| 2	| | | | |
...
| STeX | [![alt text][web]](https://trade.50x.com/) | | [![alt text][whitepaper]](https://stex.exchange/media/pdf/whitepaper.pdf) |   | (dev) | a2a protocol | 3 5 9 | | | | |
...
| 	Swap	|  |	| [![alt text][whitepaper]](https://swap.tech/whitepaper/) | `OPRO` | 	(dev)	| swap protocol	| 2	| ERC20 Tokens  | Ethereum | | |
...
| 	The World Exchange	| | [![alt text][github]](https://github.com/pftq/TheWorldExchange/)	| | | 	(operating)	| 	ripple protocol	| 	| | | | |
| 	Tokena | 	[![alt text][web]](https://tokena.co/) |	| | | 	(dev)	| TBC	| 	| | EOS | | |
| Token Changer | [![alt text][web]](https://tokenchanger.io/) |   | [![alt text][whitepaper]](https://medium.com/tokenchanger/token-changer-whitepaper-18c0e7227c25) |   | (dev) | multi protocol |   | | | | |
...
| 	Trade.io | 	[![alt text][web]](https://trade.io/) |	| | | 	(dev)	| raiden protocol	| 	| | | | |
| 	TRON DEX | 	[![alt text][web]](https://trx.market) | [![alt text][github]](https://github.com/tronprotocol)	| | | 	(operating)	| tron protocol	| 	| | | | |
...
| txbit.io | [![alt text][web]](https://txbit.io/) |   |   |   | [(announced)](https://twitter.com/SolarisCoin/status/963538742047838209) | xevan protocol |   | | | | |
...
| Volentix |  [![alt text][web]](https://www.volentix.io) | [![alt text][github]](https://github.com/Volentix) | [![alt text][whitepaper]](https://volentix.io/vdex-white-paper/#3.4vtx) |  | (dev) | EOS | | | EOS | Volentix Labs | |
...
| 	weiDex	| 	[![alt text][web]](https://weidex.market/) | [![alt text][github]](https://github.com/weichain/weidex-eth) | [![alt text][whitepaper]](https://weidex.market/documents/whitepaper.pdf?v=1.0.1) | `FULLY` | 	(dev)	| 	TBC	| 	| | | | |
| 	Weswap	| 	[![alt text][web]](https://www.weswap.io/) | [![alt text][github]](https://github.com/weswapexchange) | | `FULLY` | 	(dev)	| 	0x protocol	| | ERC20 tokens | Ethereum | | |
| 	Wyvern	| 	[![alt text][web]](https://exchange.projectwyvern.com/) |	[![alt text][github]](https://github.com/ProjectWyvern/wyvern-ethereum) | [![alt text][whitepaper]](https://github.com/ProjectWyvern/wyvern-protocol/blob/master/build/whitepaper.pdf) | | 	(operating - alpha)	| wyvern protocol	| 1 | non-fungible Ethereum assets  | Ethereum | | |
| WizExchange | [![alt text][web]](https://crowdwiz.io/) | [![alt text][github]](https://github.com/CrowdWiz-io/) | | `DD` `DG` | (dev) | TBC |   | | | | |
...
| 	YouDEX	| 	[![alt text][web]](http://youdex.io/) | [![alt text][github]](https://github.com/YouDex)	| [![alt text][whitepaper]](http://youdex.io/white-paper/) | | 	(dev)	| 	[CDX protocol](https://github.com/YouDex/cdx) | 	| | | | |
| YouStock | [![alt text][web]](https://youstock.io/) | [![alt text][github]](https://github.com/YouStock) | [![alt text][whitepaper]](http://youstock.io/whitepaper.pdf) | `DS` | (dev) | atomic swap protocol | 11 | | | | |
| zDEX | [![alt text][web]](https://pivx.org/zdex/) | [![alt text][github]](https://github.com/PIVX-Project/) |   |   | [(announced)](https://steemit.com/cryptocurrency/@pivx/have-you-heard-of-zdex) | zerocoin protocol | 10 | | | | |
| Zeus | [![alt text][web]](https://zeus.exchange/) |   | [![alt text][whitepaper]](https://www.dropbox.com/s/cwujvhyev6rfhcj/20180608-zeus-exchange-white-paper-v2-eng.pdf?dl=0)   |   | (dev) | nem protocol | 3 | | | | |
| ZigZag | [![alt text][web]](https://zigzag.bitlum.io/) | [![alt text][github]](https://github.com/bitlum) | [![alt text][whitepaper]](https://medium.com/bitlum/zigzag-alpha-release-12b7c56e53b2) | | (dev) | lightning network protocol | ⚡️ | | | | |
...
+ [https://0xtracker.com](https://0xtracker.com/relayers)
+ [https://dex.watch/](https://dex.watch/)
